...
//cosole.log(Date.parse(date));

// 9. getDay()

console.log(date.getDay()); //vraca vrednost izmedju 0-6(dani u nedelji)
...
// Write a JavaScript function to get the number of the days in a month.

const getDaysInMonth = (month, year) => {
  const datte = new Date(year, month, 0, 22, 22, 22).getDate();
  return date;
};

//saljemo godinu, mesec,
console.log(new Date(2023, 0, 22, 22, 22));
