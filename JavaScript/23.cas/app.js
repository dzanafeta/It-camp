/* 1.	Uneti string se šifruje tako što se zamenjuje redosled znacima u stringu. 
Prvi i drugi zamene mesta, zatim 3. i 4. zamene mesta itd. Npr.
 za string 'Pera ima devojku', treba dobiti 'ePari amd vejouk'.
...
/* 2. Unose se dva stringa A i B. Kreirati novi string kao kombinaciju stringova A i B,
...
//   const [username, domen] = email.split("@");

//   const prviKarakter = username.charAt(0);

//   const poslednjiKarakter = username.charAt(username.length - 1);

//   let zasticeniUsername = prviKarakter;
...
//   zasticeniUsername += poslednjiKarakter;

//   return zasticeniUsername + "@" + domen;
// }

// console.log(zastitiEmail("robin_singh@example.com"));
