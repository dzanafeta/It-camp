...
console.log(5 * "string");
// NaN je broj cija vrednsot nije korektna.
// Tip NaN je number
...
console.log(5 == 5);
console.log(5 == "5"); //imaju istu vrednsot. ali im je razlicit tip
console.log("leva" == "desna");

// === Proverava jednakost tipa i vrednsoti dve strane.
...
// ! logicko not => Vratice nam boolean. Koji ce da bude suprotne vrednosti od promenljive.
console.log(!isSunny);
